<template>
  <el-form ref="form" :model="form" :rules="rules" label-width="200px">
    ...
    <el-form-item v-if="category == '3'" label="是否为叶子节点" prop="isLeaf">
      <el-select v-model="form.isLeaf" placeholder="请选择是否为叶子节点">
  ...
  export default {
    ...
    activated() {
      ...
      if (this.category == '3') {
        ...
        this.form.level = this.detail.level ? this.detail.level + 1 : 1
        this.form.isLeaf = 'NO'
      }
