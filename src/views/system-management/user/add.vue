    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item label="照片" prop="avatar">
          <el-upload :headers="uploadAvatarHeaders" :show-file-list="false" :with-credentials="true"
                     :on-success="uploadAvatarSuccess" :on-error="uploadAvatarError" :action="uploadAvatar"
    ...
    <el-row>
      <el-col :span="12">
        ...
        <el-form-item label="性别" prop="gender">
          <el-radio v-for="item in dictionaries.gender" v-model="form.gender" :key="item.key" :label="item.key">{{
            item.value }}
          </el-radio>
        </el-form-item>
