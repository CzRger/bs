<template>
  <div class="infinite-warp" :class="wrapClass" @mouseenter="stop()" @mouseleave="start()">
  ...
  export default {
    ...
    methods: {
      ...
      getComputedTranslateY: function (dom) {
        let startY = 0
        const style = window.getComputedStyle ? window.getComputedStyle(dom, null) : null || dom.currentStyle
